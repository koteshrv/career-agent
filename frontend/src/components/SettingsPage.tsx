        ...
        {activeTab === "jobsearch" && (
          <>
            ...
            <div className="bg-card rounded-lg border border-border p-6 space-y-4">
              <div>
                <h3 className="text-base font-semibold text-foreground mb-1">Scraping Schedule</h3>
                <p className="text-sm text-muted-foreground mb-4">Set how often the background scraper runs automatically.</p>
