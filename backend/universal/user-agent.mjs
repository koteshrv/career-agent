...
// variants: career-agent/1.3, career-agent/1.0, career-agent-seeds/1.0,
// career-agent-liveness/1.0 — no known reason for the distinct identifiers,
...
export const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; career-agent/1.0; +https://github.com/koteshrv/job-scraper)';

/**
 * Browser-like User-Agent for callers that must clear WAF/CDN bot management
 * blocking the plain career-agent UA outright (seen live: Glints' firewall,
